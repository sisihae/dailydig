...
3. Follow the plan/spec docs in `docs/`
...
- Built with FastAPI, SQLAlchemy, Spotify API, Telegram Bot API, and OpenAI/Claude LLMs.
- See `docs/specs/` for full design rationale.
